...
const agent: AgentConfig = {
  ...
  description: "Esperto in infrastrutture scalabili e tecnologie cloud moderne.",
  skills: ["Microservizi","Kubernetes","Scalabilità Globale"],
  whenToUse: "Per valutare come distribuire l'applicazione su larga scala garantendo performance e affidabilità.",
  role: "debater",
