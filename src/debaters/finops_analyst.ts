...
const agent: AgentConfig = {
  ...
  description: "Analista specializzato nel controllo dei costi infrastrutturali e cloud.",
  skills: ["Ottimizzazione Budget Cloud","Previsione Costi","ROI Tecnologico"],
  whenToUse: "Per assicurarsi che l'architettura tecnica non eroda i margini di profitto a lungo termine.",
  role: "debater",
