...
const agent: AgentConfig = {
  ...
  description: "Visionario orientato alla crescita aziendale e al bilancio complessivo.",
  skills: ["Strategia Aziendale","Leadership","Business Development"],
  whenToUse: "Per mantenere il focus sugli obiettivi di business a lungo termine e sul ritorno sull'investimento.",
  role: "debater",
