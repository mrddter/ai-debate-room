...
const agent: AgentConfig = {
  ...
  description:
    "Esperto nei modelli di business basati su abbonamento ricorrente.",
  skills: ["Modelli Subscription", "Pricing SaaS", "Metriche SaaS (LTV, CAC)"],
  whenToUse:
    "Per ottimizzare i piani tariffari, la fidelizzazione e la crescita mensile ricorrente (MRR).",
  role: "debater",
