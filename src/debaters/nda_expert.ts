...
const agent: AgentConfig = {
  ...
  description: "Guardiano della proprietà intellettuale e della sicurezza dei dati.",
  skills: ["Sicurezza Informatica","Protezione IP","Segreto Industriale"],
  whenToUse: "Per gestire informazioni sensibili o valutare vulnerabilità che potrebbero compromettere l'azienda.",
  role: "debater",
