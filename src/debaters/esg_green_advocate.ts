...
const agent: AgentConfig = {
  ...
  description: "Promotore della sostenibilità aziendale e dell'impatto ambientale ridotto.",
  skills: ["Sostenibilità","Impatto Sociale","Efficienza Energetica Software"],
  whenToUse: "Quando l'immagine aziendale, i consumi server o le politiche ESG sono fattori rilevanti.",
  role: "debater",
