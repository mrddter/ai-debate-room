...
const agent: AgentConfig = {
  ...
  description: "Specialista nella progettazione di sistemi di intelligenza artificiale distribuiti.",
  skills: ["Architettura Software","Multi-Agente","Ottimizzazione Risorse AI"],
  whenToUse: "Per valutare la fattibilità tecnica di una soluzione AI o per strutturare sistemi complessi.",
  role: "debater",
