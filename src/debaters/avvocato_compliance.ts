...
const agent: AgentConfig = {
  ...
  description: "Esperto in conformità normativa e regolamentazioni digitali (es. GDPR, AI Act).",
  skills: ["Diritto Digitale","Privacy","Compliance Normativa"],
  whenToUse: "Per identificare rischi legali e assicurare che la soluzione proposta sia a norma di legge.",
  role: "debater",
