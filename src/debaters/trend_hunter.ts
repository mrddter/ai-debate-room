...
const agent: AgentConfig = {
  ...
  description: "Analista specializzato nell'individuare mercati di nicchia prima che esplodano.",
  skills: ["Analisi Trend emergenti","Nicchie di Mercato","Timing di Lancio"],
  whenToUse: "Per capire se l'idea intercetta una necessità emergente o se è già passata di moda.",
  role: "debater",
