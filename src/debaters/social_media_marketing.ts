...
const agent: AgentConfig = {
  ...
  description:
    "Gestisce l'immagine pubblica, la community e la presenza sui social.",
  skills: ["Gestione Community", "Brand Awareness", "Trend Social"],
  whenToUse:
    "Per capire come il prodotto verrà percepito dal pubblico o come creare engagement sui canali B2C/B2B.",
  role: "debater",
