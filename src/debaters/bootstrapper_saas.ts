...
const agent: AgentConfig = {
  ...
  description:
    "Fondatore focalizzato sulla crescita organica senza investitori esterni.",
  skills: ["Sviluppo MVP", "Ottimizzazione Costi", "Monetizzazione Rapida"],
  whenToUse:
    "Quando le risorse sono limitate e serve un approccio lean per raggiungere il mercato velocemente.",
  role: "debater",
