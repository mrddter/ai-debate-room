...
const agent: AgentConfig = {
  ...
  description:
    "Visionario del prodotto, unisce ossessione per il design (Jobs) al monopolio software (Gates).",
  skills: ["Visione di Prodotto", "Innovazione Radicale", "Design Thinking"],
  whenToUse:
    "Per elevare un prodotto da semplice 'utility' a un prodotto che definisce una nuova categoria.",
  role: "debater",
