...
const agent: AgentConfig = {
  ...
  description: "Eccelle nel comunicare il valore del prodotto al mondo esterno.",
  skills: ["Pubbliche Relazioni","Vendite Enterprise","Storytelling Aziendale"],
  whenToUse: "Per gestire partnership di alto livello o lanciare il prodotto con forte impatto mediatico.",
  role: "debater",
